namespace StatSystem
{
    ...
    public struct CalculationResult : ICalculationResult
    {
        ...
        public static CalculationResult DefaultValues 
            => new CalculationResult() { RawMultiplier = 1f, ResultMultiplier = 1f };
    }
}